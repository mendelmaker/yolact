...
CUSTOM_CLASSES = ('backpack', 'vent', 'phone', 'survivor')  # This is just an example, modify it as you like.
...
coco_dataset = Config({'name': 'COCO 2017',
                       'train_images': '/home/alex/yolact_tmp/Yolact_minimal/data/train2017',
                       'train_info': '/home/alex/yolact_tmp/Yolact_minimal/data/annotations/instances_train2017.json',
                       'valid_images': '/home/alex/yolact_tmp/Yolact_minimal/data/val2017/',
                       'valid_info': '/home/alex/yolact_tmp/Yolact_minimal/data/annotations/instances_val2017.json',
...
custom_dataset = Config({'name': 'SubT',
                         'train_images': '/home/alex/yolact_tmp/Yolact_minimal/data/SubT_urban_train',  # No need to add 'JPEGImages/'.
                         'train_info': '/home/alex/yolact_tmp/Yolact_minimal/data/annotations/SubT_urban_train.json',
                         'valid_images': '/home/alex/yolact_tmp/Yolact_minimal/data/SubT_urban_val',
                         'valid_info': '/home/alex/yolact_tmp/Yolact_minimal/data/annotations/SubT_urban_val.json',
